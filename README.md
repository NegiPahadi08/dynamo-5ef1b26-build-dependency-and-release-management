...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-5ef1b26-build-dependency-and-release-management`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-5ef1b26-build-dependency-and-release-management --clone
cd dynamo-5ef1b26-build-dependency-and-release-management
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-5ef1b26-build-dependency-and-release-management --fill
```
